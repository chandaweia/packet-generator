...
genpacketfile=$HOME/packet-generator/gtp_dl_packet.py
...
pcapfile=$PWD/dl_gtp_icmp_echo_request_$1.pcap
pcaploop=$PWD/dl_gtp_icmp_echo_request_$1_loop.pcap
$genpacketfile $1
...
rm dl_gtp_icmp_echo_request*.pcap
